...
namespace Parser {
    ...
    public class SequenceStatement : Statement {
        ...
        public SequenceStatement LeftMost() {
            SequenceStatement t = this;
            while (t.head != null) {
                if (t is SequenceStatement) {
                    t = (SequenceStatement)t.head;
                } else {
    ...
    public class BinaryOperatorExpression : Expression {
        ...
        public BinaryOperatorExpression LeftMost() {
            BinaryOperatorExpression t = this;
            while (t.left != null) {
                if (t is BinaryOperatorExpression) {
                    t = (BinaryOperatorExpression)t.left;
                } else {
                    throw new NotImplementedException();
                }
            }
